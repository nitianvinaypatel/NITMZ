...
import com.nitmizoram.nitmz.model.TnPData;
...
//                String items = adapterView.getItemAtPosition(i).toString();
        ...
        updatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                name_P = Objects.requireNonNull(Pname.getText()).toString().trim();
                department_P = Objects.requireNonNull(Pdepartment.getText()).toString().trim();
                phone_P = Objects.requireNonNull(Pphone.getText()).toString().trim();
                email_P = Objects.requireNonNull(Pemail.getText()).toString().trim();
            ...
            private void uploadImage() {
                if (selectedImageUri != null) {
                    ...
                    databaseReference.child("TnP Cell").child(post_name).child("imageUrl").get().addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            imageUrlP = String.valueOf(task.getResult().getValue());
                            uploadData();
                        } else {
