        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            private void uploadImage() {
                if (selectedImageUri != null) {
                    ...
                    StorageReference reference = storage.getReference().child("Faculty").child(Ukey);
                    ...
                    databaseReference.child("Faculty").child(Ukey).child("fimageUrl").get().addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            onBackPressed();
                            Toast.makeText(UpdateFaculty.this, "Failed to fetch image URL", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
            ...
            private void uploadData() {
                ...
                databaseReference.child("Faculty").child(Ukey).updateChildren(updateData)
                        .addOnSuccessListener(unused -> {
                            progressDialog.dismiss();
                            onBackPressed();
                            Toast.makeText(UpdateFaculty.this, "Faculty details Updated Successfully", Toast.LENGTH_SHORT).show();
                        })
                        .addOnFailureListener(e -> {
                            progressDialog.dismiss();
                            onBackPressed();
                            Toast.makeText(UpdateFaculty.this, "Failed to update faculty details", Toast.LENGTH_SHORT).show();
                        });
            }
