...
import com.nitmizoram.nitmz.adapter.DeleteFacultyAdapter;
...
public class DeleteFaculty extends AppCompatActivity {
    ...
    private DeleteFacultyAdapter adapter;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    adapter = new DeleteFacultyAdapter(getApplicationContext(), list);
