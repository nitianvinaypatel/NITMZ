...
import com.nitmizoram.nitmz.DeleteFaculty;
...
public class AddFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteF.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), DeleteFaculty.class);
            startActivity(intent);
        });

        unikey = databaseReference.child("Faculty").push().getKey();
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            private void uploadImage() {
                if (selectedImageUri != null) {
                    StorageReference reference = storage.getReference().child("Faculty").child(unikey);
            ...
            private void uploadData() {
                ...
                databaseReference.child("Faculty").child(unikey).setValue(facultyData)
                        .addOnSuccessListener(unused -> {
                            progressDialog.dismiss();
                            onBackPressed();
                            Toast.makeText(AddFaculty.this, "Faculty details Added Successfully", Toast.LENGTH_SHORT).show();
                            // If needed, you can also navigate to a new activity or perform other actions here
                        })
                        .addOnFailureListener(e -> {
                            progressDialog.dismiss();
                            onBackPressed();
                            Toast.makeText(AddFaculty.this, "Failed to add faculty details", Toast.LENGTH_SHORT).show();
                        });
            }
