...
public class UploadPyqs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_pyqs);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(UploadPyqs.this, R.layout.dropdown_item, Course);
        ...
        autoCompleteTextView_course.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            path = "PYQs/" + selectedCourse + "/" + selectedSemester + "/" + selectedBranch + "/";
        });

        autoCompleteTextView_branch = findViewById(R.id.autoComplete_branch);

        adapter = new ArrayAdapter<>(UploadPyqs.this,R.layout.dropdown_item,branch);
        ...
        adapter = new ArrayAdapter<>(UploadPyqs.this,R.layout.dropdown_item,semester);
    ...
    private void uploadData(String ignoredS) {
        ...
        databaseReference.child(path).child(Objects.requireNonNull(uniqeKey)).setValue(data).addOnCompleteListener(task -> {
            ...
            Intent intent = new Intent(getApplicationContext(), UploadPyqs.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==REQ && resultCode ==RESULT_OK){
            ...
            if(Objects.requireNonNull(pdfData).toString().startsWith("content://")){
                try {
                    Cursor cursor;
                    cursor = UploadPyqs.this.getContentResolver().query(pdfData,null,null,null,null);
