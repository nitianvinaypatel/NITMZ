...
public class UploadBooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(UploadBooks.this, R.layout.dropdown_item, Course);
        ...
        autoCompleteTextView_course.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            path = "Books/" + selectedCourse + "/" + selectedSemester + "/" + selectedBranch + "/";
        });

        autoCompleteTextView_branch = findViewById(R.id.autoComplete_branch);

        adapter = new ArrayAdapter<>(UploadBooks.this, R.layout.dropdown_item, branch);
        ...
        adapter = new ArrayAdapter<>(UploadBooks.this, R.layout.dropdown_item, semester);
    ...
    private void uploadData(String ignoredS) {
        ...
        databaseReference.child(path).child(Objects.requireNonNull(uniqeKey)).setValue(data).addOnCompleteListener(task -> {
            ...
            Intent intent = new Intent(getApplicationContext(), UploadBooks.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQ && resultCode == RESULT_OK) {
            ...
            if (Objects.requireNonNull(pdfData).toString().startsWith("content://")) {
                try {
                    Cursor cursor;
                    cursor = UploadBooks.this.getContentResolver().query(pdfData, null, null, null, null);
