...
public class PyqSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pyq_selection);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(PyqSelection.this, R.layout.dropdown_item, Course);
...
//                String items = adapterView.getItemAtPosition(i).toString();
        ...
        adapter = new ArrayAdapter<>(PyqSelection.this,R.layout.dropdown_item,branch);
...
//                String items = adapterView.getItemAtPosition(i).toString();
        ...
        adapter = new ArrayAdapter<>(PyqSelection.this,R.layout.dropdown_item,semester);
...
//                String items = adapterView.getItemAtPosition(i).toString();
        ...
        buttonGet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isValidInput()) {
                    Intent intent = new Intent(getApplicationContext(), PyqShow.class);
