...
public class SyllabusShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syllabus_show);
        ...
        String path = "Syllabus/" + course + "/" + semester + "/" + branch;
    ...
    private void getData() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new PdfAdapter(SyllabusShow.this,list);
                recyclerView.setLayoutManager(new LinearLayoutManager(SyllabusShow.this));
